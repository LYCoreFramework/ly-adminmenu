...
local menuLocation = 'topleft' -- e.g. topright (default), topleft, bottomright, bottomleft

local menu = MenuV:CreateMenu(false, Lang:t("menu.admin_menu"), menuLocation, 133, 193, 233, 'size-125', 'none', 'menuv', 'test')
local menu2 = MenuV:CreateMenu(false, Lang:t("menu.admin_options"), menuLocation, 133, 193, 233, 'size-125', 'none', 'menuv', 'test1')
local menu4 = MenuV:CreateMenu(false, Lang:t("menu.online_players"), menuLocation, 133, 193, 233, 'size-125', 'none', 'menuv', 'test3')
local menu5 = MenuV:CreateMenu(false, Lang:t("menu.manage_server"), menuLocation, 133, 193, 233, 'size-125', 'none', 'menuv', 'test4')
local menu6 = MenuV:CreateMenu(false, Lang:t("menu.weather_conditions"), menuLocation, 133, 193, 233, 'size-125', 'none', 'menuv', 'test5')
local menu8 = MenuV:CreateMenu(false, Lang:t("menu.ban"), menuLocation, 133, 193, 233, 'size-125', 'none', 'menuv', 'test7')
local menu9 = MenuV:CreateMenu(false, Lang:t("menu.kick"), menuLocation, 133, 193, 233, 'size-125', 'none', 'menuv', 'test8')
local menu10 = MenuV:CreateMenu(false, Lang:t("menu.permissions"), menuLocation, 133, 193, 233, 'size-125', 'none', 'menuv', 'test9')
local menu11 = MenuV:CreateMenu(false, Lang:t("menu.developer_options"), menuLocation, 133, 193, 233, 'size-125', 'none', 'menuv', 'test10')
local menu12 = MenuV:CreateMenu(false, Lang:t("menu.vehicle_options"), menuLocation, 133, 193, 233, 'size-125', 'none', 'menuv', 'test11')
local menu13 = MenuV:CreateMenu(false, Lang:t("menu.vehicle_categories"), menuLocation, 133, 193, 233, 'size-125', 'none', 'menuv', 'test12')
local menu14 = MenuV:CreateMenu(false, Lang:t("menu.vehicle_models"), menuLocation, 133, 193, 233, 'size-125', 'none', 'menuv', 'test13')
